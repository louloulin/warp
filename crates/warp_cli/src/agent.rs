...
pub enum Harness {
    ...
    #[value(name = "gemini")]
    Gemini,
    /// Generic HTTP harness for OpenAI-compatible APIs (Ollama, LM Studio, etc.).
    #[value(name = "generic")]
    Generic,
...
impl Harness {
    ...
    pub fn parse_local_child_harness(value: &str) -> Option<Self> {
        match Self::parse_orchestration_harness(value) {
            ...
            Some(Self::Oz) | Some(Self::Gemini) | Some(Self::Generic) | Some(Self::Unknown)
            | None => None,
        }
    }
